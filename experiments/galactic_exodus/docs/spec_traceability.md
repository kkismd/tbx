...
| `LEGACY_CONSOLIDATED_SPEC` | `experiments/galactic_exodus/srs/phase2_srs_spec.md` | `experiments/galactic_exodus/docs/archive/phase2_srs_spec.md` | `archived` | `experiments/galactic_exodus/docs/specs/srs_movement.md`, `experiments/galactic_exodus/docs/specs/srs_objects.md`, `experiments/galactic_exodus/docs/specs/srs_warp.md`, `experiments/galactic_exodus/docs/specs/srs_combat.md`, `experiments/galactic_exodus/docs/specs/srs_encounter.md`, `experiments/galactic_exodus/docs/specs/display.md` | #1318 |
...
| `experiments/galactic_exodus/phase1_spec.md` | `## 4-6` | fuel / supply / win-lose / seed / fixture injection | `docs/specs/phase1.md` | fuel、`BASE` / `RESOURCE`、`WON` / `LOST_FUEL` / abort、seed reroll、fixture injection を current contract として移植した。 | `MIGRATED` | なし | 維持のみ。 | #1323 |
| `experiments/galactic_exodus/phase1_spec.md` | `## 7-10` | UI contract / GameLog / comparison / reference fixture | `docs/specs/phase1.md` | Phase 1 UI meaning contract、`GameLog` schema v3、`TurnEvent` / `final_summary` field、Python/TBX 比較境界、reference fixture schema v1 を current docs へ移植した。 | `MIGRATED` | なし | 維持のみ。 | #1323 |
| `experiments/galactic_exodus/phase1_spec.md` | `## 11-14` | historical notes / implementation order | `docs/specs/phase1.md` appendix または legacy のまま | `phase1.md` は `historical appendix` を設け、履歴情報を current gameplay 本文から分離した。詳細な履歴本文は legacy 文書を参照する。 | `OBSOLETE` | current source にそのまま移すと歴史メモと仕様を混ぜる。 | 維持のみ。 | #1323 |
